...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--fp16', help="Use fp16 to train", action="store_true")
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--wandb_entity', type=str, default='ruiqi24', help='Wandb entity')
    parser.add_argument('--wandb_project', type=str, default='mammoth', help='Wandb project name')
    
    parser.add_argument('--dataset_path', type=str, default=None,
                        help='Optional dataset path for the GrainSpace dataset')
